...
class VideoAspect(str, Enum):
    ...
    def to_resolution(self):
        preset = str(config.app.get("video_resolution", "1080p")).strip().lower()
        presets = _VIDEO_RESOLUTION_PRESETS.get(preset, _VIDEO_RESOLUTION_PRESETS["1080p"])
...
# Base resolution presets, selected via the ``video_resolution`` app config.
# Pexels/Pixabay material search prefers renditions closest to these targets,
# and the final composition always resizes clips to the chosen resolution.
_VIDEO_RESOLUTION_PRESETS = {
    ...
    "540p": {"landscape": (960, 540), "portrait": (540, 960), "square": (540, 540)},
